...
public class PaddleMovement : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            //está escrito de esta forma (y no con una variable con el animador), porque de la otra forma daba un error ignorable (lo mismo con la línea de OnCollisionExit)
